...
const Footer = () => (
  <footer className="w-full relative pt-12 pb-12 bg-black text-white">
    <div className="grid">
      <ul className="grid-end-3 relative">
      ...
      <div className="grid-end-3 relative">
        <h4 className="mb-4 b3">Shop</h4>

        <ul>
          <li className="caption uppercase">
            <Link to="/products" className="inline-block py-1 hover-underline">
              Products
            </Link>
          </li>
      ...
      <div className="grid-end-3 relative">
        ...
        <ul>
          ...
          <li className="caption uppercase">
            <Link to="/shipping" className="inline-block py-1 hover-underline">
              Shipping
            </Link>
          </li>
